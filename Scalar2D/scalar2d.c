...
int main(void){
    ...
    if(scelta==1 || scelta==2){
        ...
        while(Nt!=NULL){
            ...
            sprintf(filemisure, "/home/dario/Documents/UNI/Metodi/Modulo3/Scalar2D/Continuo/misure(Ntm=%.3f,Nxm=%.3f,Nt=%.0f,Nx=%d,m=%.4f).txt", Ntm, Nxm, Nt->val, Nx, m); //it modifies each time the name of the file to etae created
