...
void energy(){
    ...
    float force_s=0, force_t=0, phi, force_plus_s=0, force_minus_s=0, force_plus_t=0, force_minus_t=0;
...
//  apertura file da dove leggere i parametri della simulazione
    ...
    x= fscanf(input, "%d  %d  %d  %f  %d", &i_flag, &measures, &i_decorrel, &extfield, &i_term);
