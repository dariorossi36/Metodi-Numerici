In this repository there are programs for a Master exam called "Metodi numerici per la Fisica", (Numerical methods for Physics). It is composed of 3 parts: the first one deals with 
